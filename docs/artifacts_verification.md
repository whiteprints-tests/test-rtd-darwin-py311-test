...
```console
gh attestation verify <path_to_the_release_artifact> --repo whiteprints-tests/test-rtd-darwin-py311-test
```
...
cosign verify-blob \
    ...
    --certificate-identity-regexp="^https://github.com/whiteprints-tests/test-rtd-darwin-py311-test/.github/workflows/upload_artifacts.yml?" \
